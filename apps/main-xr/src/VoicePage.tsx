      ...
      if (!navigator.mediaDevices?.getUserMedia) {
        setError(
          window.isSecureContext
            ? "This runtime does not expose microphone access via MediaDevices."
            : "Microphone access requires a secure context like localhost or HTTPS.",
        );
        return;
      }

      if (typeof MediaRecorder === "undefined") {
        setError("This runtime does not support MediaRecorder audio capture.");
        return;
      }
